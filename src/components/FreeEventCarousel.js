...
export default function FreeEventCarousel ({
  listOfEvents,
  eventImages,
  title,
  displayTitle
  ...
  if (listOfEvents !== null && listOfEvents !== undefined) {
    return (
      <>
      <h1 className='crousel-title'>{displayTitle}</h1>
        <div
          id={`infinite-carousel-${title}`}
          className='d-flex justify-content-center align-items-center'
        >
          <button className='control slider-button left-button'>
          ...
          >
            {listOfEvents.map((event, index) => {
              ...
              return (
                <div
                  className='col-6 col-sm-4 col-md-3 col-xl-3 text-center list-item event-card'
                  key={index}
                >
                  {event.payment === 'free' ? (
                    <a href={link} className='carousel-image-container'>
                      ...
                      <div className='play-icon position-absolute'>
                        <i
                          class='fa fa-play fa-3x fa-play-icon image-over-font'
                          aria-hidden='true'
                        ></i>
                    ...
                    <Link to={{ pathname: '/show-event', event: event }}>
                      ...
                      <div className='play-icon position-absolute'>
                        <i
                          class='fa fa-play-circle-o fa-3x fa-play-icon image-over-font'
                          aria-hidden='true'
                        ></i>
                        <label className='text-white image-over-font'>
                          &nbsp;&nbsp;{event.title}
          ...
          <button className='control slider-button right-button'>
