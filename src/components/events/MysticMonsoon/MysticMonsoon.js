...
import MysticMonsoonBanner from '../../../images/mystic-monsoon-banner.png';
import EventCarousel from '../../EventCarousel.js';


export default function MysticMonsoon(props){
    ...
    useEffect(() => {
        if (listOfEvents.length === 0) {
            const db = firebaseAppConfig.database().ref('concertseries/mysticmonsoon');
            db.on("value", (events) => {
        ...
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <img src={MysticMonsoonBanner} alt="mystic-monsoon-banner" className="w-100 mm-banner" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="event-image countdown-boxshadow pb-5">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="pt-5 opacity-3 text-white">This unique musical series is an attempt to showcase the various colours of monsoon season captured in north Indian classical music, Indian film music and works of Nobel laureate Rabindranath Tagore. Each episode will be a blissful musical presentation walking you through one of these. Sit back, relax and get drenched in the mysticism of the monsoon, embarking on a journey through the rhythm of rain!</p>
                    ...
                    {listOfEvents !== null && listOfEvents !== undefined && listOfEvents.length !== 0 ? (
                        Object.keys(listOfEvents[0].episodes).map((year) => {
                            let display = "d-none";
