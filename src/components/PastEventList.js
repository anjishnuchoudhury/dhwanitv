                              ...
                              <div className="col-xl-8 col-lg-8 col-md-8 col-12 py-4">
                                  <div className="row">
                                    <div className="col-12">
                                      {event.payment === "free" ? (<Link to={{pathname: "/view-event", event: event}} className="text-white">
                                      ...
                                      {isEventRegistered && isCustomerLoggedIn ? (
                                        ...
                                        event.payment === "free" ?  (
                                          <Link to={{pathname: "/view-event", event: event}} className="btn btn-magenta col-md-6 col-12">View Event</Link>
                                            ...
                                            event.url? (<a href={`/${event.url}`} className="btn btn-magenta col-md-6 col-12">View Event</a>) : (<Link to={{ pathname: "/show-event", event: event }} className="btn btn-magenta col-md-6 col-12">Buy tickets</Link>)
                                            ))}
                                    </div>
                                  </div>
                              </div>
