...
const Header = () => {
  ...
  return (
    <div className="header-background">
      <div className="">
        {/* desktop menu */}
        <div className="row align-items-center justify-content-between d-lg-flex d-none">
          ...
          <div className="col-xl-2 col-lg-6 col-md-2">
            {currentUser ? (
              <div className="d-flex align-items-center justify-content-around">
                <div className="dropdown btn-group">
                  ...
                  >
                    {/* <span className='profile-name-dropdown d-xl-none'>
                      <small>
                        Logged in as:
                        <br />
                      </small>
                    ...
                    <div className="dropdown-divider d-xl-none"></div>
                    <a
                      className="dropdown-item dropdown-hover cursor-pointer"
                      href="/my-events"
                    >
                      My events
                    </a>
        ...
        {/* mobile view  */}
        <div className="align-items-center pl-2 pr-4 justify-content-between d-lg-none d-flex">
          <a href="/home">
            <img
              src={dhwaniLogo}
              alt="Dhwani_Logo"
